...
Click here to view my [CV](https://frozzzen3.github.io/files/Guodong_Chen_CV_2026_03_28.pdf).

 <!--Click here to view my [CV](https://frozzzen3.github.io/files/Guodong_Chen_CV_10_12.pdf). -->

# 🔥 News
- *2026.03*: &nbsp;🎉 Our paper has been conditionally accepted to the [2026 SIGGRAPH](https://s2026.siggraph.org/)! Stay tuned for its official release.
- *2026.02*: &nbsp;🎉 Our paper: *LMG: Efficient Streaming of Layered Mesh–Gaussian 3D Scenes* has been accepted to the [2026 MMsys](https://2026.acmmmsys.org/)!
